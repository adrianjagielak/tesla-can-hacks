/*
   ...
   Creates its own Wi-Fi network and listens on UDP port 192.168.4.1:1338
*/
...
#define AP_SSID "TeslaCAN" // Name of the Wi-Fi network
#define AP_PASSWORD "nukhid-5Buzce-harduw" // Password for the Wi-Fi network
#define AP_CHANNEL 1 // Channel 1 has best penetration characteristics
#define AP_MAX_CONNECTIONS 5 // Maximum number of clients
#define AP_HIDE_SSID false // Whether to hide the SSID
#define AP_POWER WIFI_POWER_19_5dBm // Maximum power for best signal penetration

// Static IP Configuration
IPAddress localIP(192, 168, 4, 1);  // Static IP for the ESP32
IPAddress gateway(192, 168, 4, 1);  // Gateway (same as local IP)
...
void setup() {
    ...
    WiFi.mode(WIFI_AP);
    WiFi.setTxPower(AP_POWER);
    WiFi.softAP(AP_SSID, AP_PASSWORD, AP_CHANNEL, AP_HIDE_SSID, AP_MAX_CONNECTIONS);
